...
AppId={{5F02148C-DBAD-4F36-9629-1305897F0F42}    
AppName={#MyAppName}
...
[Icons]
IconFilename: "{app}\{#MyAppName}"; Name: "{group}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; 
IconFilename: "{app}\{#MyAppName}"; Name: "{group}\{cm:UninstallProgram,{#MyAppName}}"; Filename: "{uninstallexe}"; 
IconFilename: "{app}\{#MyAppName}"; Name: "{commondesktop}\{#MyAppName}"; Filename: "{app}\{#MyAppExeName}"; Tasks: desktopicon; 
